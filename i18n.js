...
const TRANSLATIONS = {
  pt: {
    ...
    svc_my_requests:      'Minhas solicitações',
    svc_status_pending:   'Pendente',
    svc_status_confirmed: 'Confirmado',
    svc_status_completed: 'Concluído',
    ...
    profile_email_note: 'Vamos enviar um link de confirmação pro novo email. A troca só é efetivada depois que você confirmar.',
    profile_email_sent: 'Verifique sua caixa de entrada para confirmar o novo email.',
    profile_updated:    'Dados atualizados.',
  ...
  en: {
    ...
    svc_status_pending:   'Pending',
    svc_status_confirmed: 'Confirmed',
    ...
    profile_email_note: 'We\u2019ll send a confirmation link to the new email. The change only takes effect once you confirm it.',
    profile_email_sent: 'Check your inbox to confirm the new email.',
